...
use visuals::spectrum_vz::SpectrumVisualizer;
...
fn main() -> ! {
    ...
    */
    ...
    let spectrum_viz: Box<Visualizer> = SpectrumVisualizer::new(&mut history,&mut max, 2, GREEN, RED);
    /*
    ...
    */
    ...
    let mut current_visualizer = spectrum_viz;
